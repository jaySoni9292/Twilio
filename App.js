...
export default class Example extends Component {
  ...
  _onConnectButtonPress = () => {
    if (this.state.roomName != "" && this.state.email != "") {
      console.log("in on connect button preess");
      let bodyParams = {
        email: this.state.email,
        room: this.state.roomName,
      }
      fetch('https://twilio.backendengineer.cf/api/getToken', {
        ...
        .then((responseJson) => {
          ...
          this.refs.twilioVideo.connect({ roomName: this.state.roomName, email: this.state.email, accessToken: responseJson.token })
